...
1. Target log transformation (`log1p`) to stabilize variance  
2. Feature selection with explicit leakage prevention  
3. Scikit-learn `Pipeline` with:
   - Median imputation (numeric)
   - OneHot encoding (categorical)
4. RandomForestRegressor (500 trees)
5. 80/20 holdout validation
6. 5-fold cross-validation
7. Permutation importance for business-level feature interpretation
